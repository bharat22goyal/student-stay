...
from .models import Listing, Owner
from .serializers import ListingSerializer, listingDetailSerializer,CollegeSerializer
...
class CollegeView(ListAPIView):
    ...
    def get_queryset(self):
        college_name = self.kwargs['college']
        return Listing.objects.filter(college_nearby__contains=college_name).order_by('-list_date').filter(is_published=True)
