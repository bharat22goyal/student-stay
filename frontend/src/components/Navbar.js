            ...
            <nav className='navbar'>
                <div className='navbar__top'>
                    <div className='navbar__top__logo'>
                        <Link className='navbar__top__logo__link' to='/'>Student Stay</Link>
                    </div>
                ...
                <div className='navbar__bottom'>
                    {/* <li className='navbar__bottom__item'>
                        <NavLink className='navbar__bottom__item__link' exact to='/'>Search</NavLink>
                    </li> */}
                    <li className='navbar__bottom__item'>
                        <NavLink className='navbar__bottom__item__link' exact to='/listings'>Accommodations</NavLink>
                    </li>
                    <li className='navbar__bottom__item'>
                    ...
                    {/* <li className='navbar__bottom__item'>
                        <NavLink className='navbar__bottom__item__link' exact to='/contact'>Owner</NavLink>
                    </li> */}
                </div>
            </nav>
            <Alert />
