        ...
        <div className='card'>
            ...
            <div className='row'>
                <div className='col-2-of-3'>
                    <p className='card__info'>Rent: €{numberWithCommas(props.price)}</p>
                    <p className='card__info'>Bedrooms: {props.bedrooms}</p>
                    <p className='card__info'>Bathrooms: {props.bathrooms}</p>
                </div>
                <div className='col-1-of-3'>
                    <p className='card__saletype'>College: {props.college}</p>
                    {/* <p className='card__hometype'>{props.home_type}</p> */}
                    {/* <p className='card__sqft'></p> */}
                </div>
            </div>
            <Link className='card__link' to={`/listings/${props.slug}`}>View Accommodation</Link>
        </div>
    );
};
