...
const ListingDetail = (props) => {
    ...
    useEffect(() => {
        ...
        if (id) {
            axios.get(`${process.env.REACT_APP_API_URL}/api/owners/${id}`, config)
            .then(res => {
    ...
    return (
        <div className='listingdetail'>
            <Helmet>
                <title>Accommodations | {`${listing.title}`}</title>
                <meta
                    name='description'
            ...
            <div className='row'>
                ...
                <div className='col-1-of-4'>
                    ...
                    <h3 className='listingdetail__realtor'>Owner: {listing.owner}</h3>
                    <p className='listingdetail__contact'>Contact: {listing.phone}</p>
                    <p className='listingdetail__contact'>Email: {listing.email}</p>
                </div>
            </div>
            <div className='row'>
                <div className='col-1-of-2'>
                    <ul className='listingdetail__list'>
                        ...
                        <li className='listingdetail__list__item'>Rent: €{price}</li>
