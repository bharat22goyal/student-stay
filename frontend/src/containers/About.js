...
const About = () => {
    ...
    useEffect(() => {
        ...
        const getTopSeller = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/owners/topseller`, config);
    ...
    useEffect(() => {
        ...
        const getRealtors = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/owners`, config);
            ...
            <section className='about__info'>
                <div className='row'>
                    <div className='col-3-of-4'>
                        <h2 className='about__subheading'>We find the perfect student accommodation for you</h2>
